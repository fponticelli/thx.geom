...
thx_geom_EdgeCubic.prototype = {
	...
	,equals: function(other) {
		...
		var t = other;
		return thx_geom__$Point_Point_$Impl_$.nearEquals(this.p0,t.p0) && thx_geom__$Point_Point_$Impl_$.nearEquals(this.p1,t.p1) && thx_geom__$Point_Point_$Impl_$.nearEquals(this.p2,t.p2) && thx_geom__$Point_Point_$Impl_$.nearEquals(this.p3,t.p3);
	}
	...
	,intersectionsEdgeLinear: function(other) {
		return thx_core_Arrays.flatten(this.get_linearSegments().map(function(edge) {
	...
	,get_area: function() {
		if(!this._area) {
			this._area = true;
			this.area = thx_core_Arrays.reduce(this.get_linearSegments(),function(acc,edge) {
	...
	,get_length: function() {
		if(!this._length) {
			this._length = true;
			this.length = thx_core_Arrays.reduce(this.get_linearSegments(),function(acc,edge) {
	...
	,get_lengthSquared: function() {
		if(!this._lengthSquared) {
			...
			this.lengthSquared = thx_core_Arrays.reduce(this.get_linearSegments(),function(acc,edge) {
...
thx_geom_EdgeLinear.prototype = {
	...
	,equals: function(other) {
		...
		var t = other;
		return thx_geom__$Point_Point_$Impl_$.nearEquals(this.p0,t.p0) && thx_geom__$Point_Point_$Impl_$.nearEquals(this.p1,t.p1);
	}
	,matches: function(other) {
		return thx_geom__$Point_Point_$Impl_$.nearEquals(this.first,other.first) && thx_geom__$Point_Point_$Impl_$.nearEquals(this.last,other.last);
	}
...
thx_geom_Spline.fromEdges = function(arr,closed) {
	...
	if(arr.length > 0) {
		var edge = arr[0];
		var prev;
		if(closed) prev = arr[arr.length - 1]; else prev = new thx_geom_EdgeLinear(thx_geom__$Point_Point_$Impl_$.zero,thx_geom__$Point_Point_$Impl_$.zero);
		if(arr.length == 1) {
...
thx_geom_TestEdgeCubic.areaPoints = function(p0,p1) {
	var p;
	var p_0 = -p0[0];
	var p_1 = -p0[1];
	p = [p1[0] + p_0,p1[1] + p_1];
	return p0[1] * (p1[0] - p0[0]) + p[0] * p[1] / 2;
};
thx_geom_TestEdgeCubic.prototype = {
	...
	,testArea: function() {
		...
		var min = thx_geom_TestEdgeCubic.areaPoints(this.edge.p0,this.edge.p3);
		var area = this.edge.get_area();
		utest_Assert.isTrue(area > min,null,{ fileName : "TestEdgeCubic.hx", lineNumber : 33, className : "thx.geom.TestEdgeCubic", methodName : "testArea"});
		utest_Assert.isTrue(area < max,null,{ fileName : "TestEdgeCubic.hx", lineNumber : 34, className : "thx.geom.TestEdgeCubic", methodName : "testArea"});
	}
	,testLength: function() {
		var max;
		max = (function($this) {
		...
		utest_Assert.isTrue(length > min,null,{ fileName : "TestEdgeCubic.hx", lineNumber : 43, className : "thx.geom.TestEdgeCubic", methodName : "testLength"});
		utest_Assert.isTrue(length < max,null,{ fileName : "TestEdgeCubic.hx", lineNumber : 44, className : "thx.geom.TestEdgeCubic", methodName : "testLength"});
	}
...
var thx_geom_TestEdgeLinear = function() {
	this.p0 = [10,10];
	this.p1 = [60,60];
	this.edge = new thx_geom_EdgeLinear(this.p0,this.p1);
...
thx_geom_TestEdgeLinear.__name__ = ["thx","geom","TestEdgeLinear"];
thx_geom_TestEdgeLinear.prototype = {
	edge: null
	,a: null
	,b: null
	,p0: null
	...
	,testArea: function() {
		...
		var p_1 = -p1[1];
		p = [this1[0] + p_0,this1[1] + p_1];
		utest_Assert.equals(this.p0[1] * (this.p1[0] - this.p0[0]) + p[0] * p[1] / 2,this.edge.get_area(),null,{ fileName : "TestEdgeLinear.hx", lineNumber : 27, className : "thx.geom.TestEdgeLinear", methodName : "testArea"});
	}
	,testLength: function() {
		utest_Assert.equals(Math.sqrt(this.a * this.a + this.b * this.b),this.edge.get_length(),null,{ fileName : "TestEdgeLinear.hx", lineNumber : 31, className : "thx.geom.TestEdgeLinear", methodName : "testLength"});
	}
	,testSplit: function() {
		var edges = this.edge.split(0.2);
		var a = [10,10];
		var b = [20,20];
		var c = [60,60];
		utest_Assert.isTrue(edges[0].equals(new thx_geom_EdgeLinear(a,b)),null,{ fileName : "TestEdgeLinear.hx", lineNumber : 39, className : "thx.geom.TestEdgeLinear", methodName : "testSplit"});
		utest_Assert.isTrue(edges[1].equals(new thx_geom_EdgeLinear(b,c)),null,{ fileName : "TestEdgeLinear.hx", lineNumber : 40, className : "thx.geom.TestEdgeLinear", methodName : "testSplit"});
	}
	,testInterpolate: function() {
		var point = this.edge.interpolate(0.2);
		utest_Assert.isTrue((function($this) {
			var $r;
			var p_0 = 20;
			var p_1 = 20;
			$r = point[0] == p_0 && point[1] == p_1;
			return $r;
		}(this)),null,{ fileName : "TestEdgeLinear.hx", lineNumber : 45, className : "thx.geom.TestEdgeLinear", methodName : "testInterpolate"});
	}
	,testIntersectionsWithEdgeLinear: function() {
		...
		utest_Assert.isTrue(e0.intersects(e1),null,{ fileName : "TestEdgeLinear.hx", lineNumber : 59, className : "thx.geom.TestEdgeLinear", methodName : "testIntersectionsWithEdgeLinear"});
		var ps = e0.intersections(e1);
		utest_Assert.equals(1,ps.length,null,{ fileName : "TestEdgeLinear.hx", lineNumber : 61, className : "thx.geom.TestEdgeLinear", methodName : "testIntersectionsWithEdgeLinear"});
		utest_Assert.isTrue(thx_geom__$Point_Point_$Impl_$.nearEquals(ps[0],[30,30]),null,{ fileName : "TestEdgeLinear.hx", lineNumber : 62, className : "thx.geom.TestEdgeLinear", methodName : "testIntersectionsWithEdgeLinear"});
		utest_Assert.isFalse(e2.intersects(e3),null,{ fileName : "TestEdgeLinear.hx", lineNumber : 63, className : "thx.geom.TestEdgeLinear", methodName : "testIntersectionsWithEdgeLinear"});
		utest_Assert.same([],e2.intersections(e3),null,null,{ fileName : "TestEdgeLinear.hx", lineNumber : 64, className : "thx.geom.TestEdgeLinear", methodName : "testIntersectionsWithEdgeLinear"});
	}
...
var thx_geom_TestLine = function() {
	this.a = [10,10];
	this.b = [50,20];
	this.line = thx_geom_Line.fromPoints(this.a,this.b);
	this.h = thx_geom_Line.fromPoints([0,20],[10,20]);
	this.v = thx_geom_Line.fromPoints([10,0],[10,10]);
};
...
thx_geom_TestLine.prototype = {
	...
	,v: null
	,testXAtY: function() {
		utest_Assert.floatEquals(30,this.line.xAtY(15),null,null,{ fileName : "TestLine.hx", lineNumber : 22, className : "thx.geom.TestLine", methodName : "testXAtY"});
		utest_Assert.equals(-Infinity,this.h.xAtY(15),null,{ fileName : "TestLine.hx", lineNumber : 23, className : "thx.geom.TestLine", methodName : "testXAtY"});
		utest_Assert.floatEquals(10,this.v.xAtY(15),null,null,{ fileName : "TestLine.hx", lineNumber : 24, className : "thx.geom.TestLine", methodName : "testXAtY"});
	}
	,testAbsDistanceToPoint: function() {
		utest_Assert.equals(0,this.line.absDistanceToPoint(this.a),null,{ fileName : "TestLine.hx", lineNumber : 28, className : "thx.geom.TestLine", methodName : "testAbsDistanceToPoint"});
	...
	,horiz: function() {
		return thx_geom_Line.fromPoints([100,10],[200,10]);
	}
	,vert: function() {
		return thx_geom_Line.fromPoints([10,100],[10,200]);
	}
	,testIsHorizontal: function() {
		utest_Assert.isTrue(this.horiz().get_isHorizontal(),null,{ fileName : "TestLine.hx", lineNumber : 46, className : "thx.geom.TestLine", methodName : "testIsHorizontal"});
		utest_Assert.isFalse(this.vert().get_isHorizontal(),null,{ fileName : "TestLine.hx", lineNumber : 47, className : "thx.geom.TestLine", methodName : "testIsHorizontal"});
		utest_Assert.isFalse(this.line.get_isHorizontal(),null,{ fileName : "TestLine.hx", lineNumber : 48, className : "thx.geom.TestLine", methodName : "testIsHorizontal"});
	}
	,testIsVertical: function() {
		utest_Assert.isTrue(this.vert().get_isVertical(),null,{ fileName : "TestLine.hx", lineNumber : 52, className : "thx.geom.TestLine", methodName : "testIsVertical"});
		utest_Assert.isFalse(this.horiz().get_isVertical(),null,{ fileName : "TestLine.hx", lineNumber : 53, className : "thx.geom.TestLine", methodName : "testIsVertical"});
		utest_Assert.isFalse(this.line.get_isVertical(),null,{ fileName : "TestLine.hx", lineNumber : 54, className : "thx.geom.TestLine", methodName : "testIsVertical"});
	}
...
thx_geom_TestPoint.prototype = {
	...
	,testDistanceTo: function() {
		utest_Assert.equals(10,thx_geom__$Point_Point_$Impl_$.distanceTo([10,10],[0,10]),null,{ fileName : "TestPoint.hx", lineNumber : 36, className : "thx.geom.TestPoint", methodName : "testDistanceTo"});
	}
	,testPointAt: function() {
		utest_Assert.isTrue((function($this) {
			...
			var this_0 = 10;
			var this_1 = 30;
			var p = thx_geom__$Point_Point_$Impl_$.pointAt([10,20],Math.PI / 2,10);
			$r = this_0 == p[0] && this_1 == p[1];
			return $r;
		}(this)),null,{ fileName : "TestPoint.hx", lineNumber : 40, className : "thx.geom.TestPoint", methodName : "testPointAt"});
	}
	,testToAngle: function() {
		utest_Assert.floatEquals(Math.PI / 4,(function($this) {
			var $r;
			var this1;
			{
				var this_0 = 1;
				var this_1 = 1;
				var angle = Math.atan2(this_1,this_0);
				this1 = angle;
			}
			$r = this1;
			return $r;
		}(this)),null,null,{ fileName : "TestPoint.hx", lineNumber : 44, className : "thx.geom.TestPoint", methodName : "testToAngle"});
	}
...
thx_geom_TestSpline.prototype = {
	testLength: function() {
		var box = [[0,0],[10,10]];
		var spline = thx_geom_shape__$Box_Box_$Impl_$.toSpline(box);
		utest_Assert.equals(40,spline.get_length(),null,{ fileName : "TestSpline.hx", lineNumber : 13, className : "thx.geom.TestSpline", methodName : "testLength"});
	}
	,testArea: function() {
		var box = [[10,10],[20,20]];
		var spline = thx_geom_shape__$Box_Box_$Impl_$.toSpline(box);
		utest_Assert.equals(100,spline.get_area(),null,{ fileName : "TestSpline.hx", lineNumber : 19, className : "thx.geom.TestSpline", methodName : "testArea"});
	}
	,testBox: function() {
		var test = [[10,20],[30,40]];
		var spline = { center : [20,30], radius : 10};
		var box = thx_geom_shape__$Circle_Circle_$Impl_$.toSpline(spline).get_box();
		utest_Assert.isTrue(thx_geom_shape__$Box_Box_$Impl_$.equals(box,test),"expected " + thx_geom_shape__$Box_Box_$Impl_$.toString(test) + " doesn't match " + thx_geom_shape__$Box_Box_$Impl_$.toString(box),{ fileName : "TestSpline.hx", lineNumber : 26, className : "thx.geom.TestSpline", methodName : "testBox"});
	}
...
thx_geom_shape__$Circle_Circle_$Impl_$.toSpline = function(this1) {
	return thx_geom_Transformables.translate(thx_geom_shape__$Circle_Circle_$Impl_$.unitaryCircle.transform(thx_geom__$Matrix4x4_Matrix4x4_$Impl_$.scaling([this1.radius,this1.radius,1])),[this1.center[0],this1.center[1],0]);
};
